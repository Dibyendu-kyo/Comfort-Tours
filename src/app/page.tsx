    ...
    <div className="flex flex-col">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full py-8 sm:py-12 md:py-0">
          <div className="max-w-2xl">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold mb-4 sm:mb-6 text-white drop-shadow-2xl tracking-tight leading-tight">
              Corporate Chauffeur-Driven Transport Solutions
            </h1>
            ...
            Delivering safe, reliable, and professional travel services since 2006.Trusted by leading corporates across India.

            </p>
          </div>

          {/* Stats Section */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12 max-w-6xl">
            {/* Row 1 */}
            <div className="flex flex-col">
              <div className="flex items-start mb-2">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-red-500 rounded-full flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                ...
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-500">2,000+</div>
                  <div className="text-white text-sm sm:text-base leading-tight">Vehicles – From economy cars to luxury sedans & buses</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-start mb-2">
                ...
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-500">2M+</div>
                  <div className="text-white text-sm sm:text-base leading-tight">Trips completed in FY 2024</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-start mb-2">
                ...
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-500">10+</div>
                  <div className="text-white text-sm sm:text-base leading-tight">Cities served across India</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-start mb-2">
                ...
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-500">21+</div>
                  <div className="text-white text-sm sm:text-base leading-tight">Years of trusted travel excellence</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full max-w-screen-xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-primary tracking-tight">Our Services</h2>
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">Comprehensive Travel Solutions – Economy to Luxury</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Intercity Travel</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">Seamless journeys between cities with professional chauffeurs.</p>
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Intracity Travel</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">Reliable city rides for meetings, shopping, or leisure.</p>
            <Link href="/services" className="btn text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">Learn More</Link>
          </div>
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Airport Transfers</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">On-time pick-up and drop-off with 24/7 availability.</p>
            <Link href="/services" className="btn text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">Learn More</Link>
          </div>
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Long-Term Rentals</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">Flexible leasing for corporates and individuals.</p>
            <Link href="/services" className="btn text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">Learn More</Link>
          </div>
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Point-to-Point Travel</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">Direct routes with transparent pricing.</p>
            <Link href="/services" className="btn text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">Learn More</Link>
          </div>
          ...
          <div className="card flex flex-col items-center group hover:shadow-xl transition-all duration-300 p-4 sm:p-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary text-center">Corporate Shuttle Services</h3>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-4 flex-grow leading-relaxed">Route-based employee transport models.</p>
            <Link href="/services" className="btn text-white text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">Learn More</Link>
          </div>
      ...
      <section className="w-full max-w-screen-xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-gradient-to-r from-orange-500 to-blue-500 rounded-xl my-12 sm:my-16 md:my-20" style={{ background: 'linear-gradient(135deg, #e67817 0%, #007dc0 100%)' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-center">
          <div className="flex flex-col items-center px-4 sm:px-0">
            ...
            <p className="text-white/90 text-sm sm:text-base leading-relaxed">21+ years of excellence</p>
          </div>
          <div className="flex flex-col items-center px-4 sm:px-0">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/20 rounded-full flex items-center justify-center mb-3 sm:mb-4">
              <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Extensive Fleet</h3>
            <p className="text-white/90 text-sm sm:text-base leading-relaxed">2,000+ well-maintained vehicles</p>
          </div>
          <div className="flex flex-col items-center px-4 sm:px-0">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/20 rounded-full flex items-center justify-center mb-3 sm:mb-4">
              <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-white/90 text-sm sm:text-base leading-relaxed">Trusted by 75+ leading companies</p>
          </div>
          <div className="flex flex-col items-center px-4 sm:px-0">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/20 rounded-full flex items-center justify-center mb-3 sm:mb-4">
              <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-white/90 text-sm sm:text-base leading-relaxed">Always available when you need us</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-6xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-start">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group min-h-[250px] sm:min-h-[280px] md:h-[300px]">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100 rounded-full mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2 sm:mb-3 text-center leading-tight">Convenience & Flexibility</h3>
            <p className="text-gray-600 text-xs sm:text-sm text-center leading-relaxed">Vehicles available as per your needs</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group min-h-[250px] sm:min-h-[280px] md:h-[300px]">
            ...
            <p className="text-gray-600 text-xs sm:text-sm text-center leading-relaxed">Online booking & expense tracking</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 md:col-span-2 min-h-[250px] sm:min-h-[280px] md:h-[300px]">
            <div className="text-center mb-4">
              <h3 className="font-bold text-xl mb-3 text-gray-900">Diverse Options</h3>
              <p className="text-gray-600 text-base leading-relaxed mb-4">
                Economy to luxury vehicles across categories - <span className="font-semibold text-red-500">2,000+</span> vehicles for you to choose from.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 flex flex-col items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group h-[300px]">
            <div className="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100 rounded-full mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-3 text-center leading-tight">Safety First</h3>
            <p className="text-gray-600 text-sm text-center leading-relaxed">GPS-enabled fleet with trained chauffeurs</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-screen-xl mx-auto py-16 px-4 md:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-secondary tracking-tight">Our Clients</h2>
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">Trusted by 75+ leading companies across IT, BPO, and manufacturing</p>
        </div>
        <ClientCarousel />
          ...
          <div className="card flex flex-col items-start">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <span className="font-semibold text-primary text-sm">Rohit Deshmukh, Mumbai</span>
              </div>
            </div>
            <p className="text-lg mb-4">&ldquo;Comfort Tours made our corporate travel stress-free. Always punctual and professional.&rdquo;</p>
          </div>
          <div className="card flex flex-col items-start">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <div>
                ...
                <span className="font-semibold text-primary text-sm">Priya Nair, Pune</span>
              </div>
            </div>
            <p className="text-lg mb-4">&ldquo;Best transport partner we&apos;ve worked with — reliable, safe, and efficient.&rdquo;</p>
          </div>
          <div className="card flex flex-col items-start">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <div>
                ...
                <span className="font-semibold text-primary text-sm">Vijay Kulkarni, Nagpur</span>
              </div>
            </div>
            <p className="text-lg mb-4">&ldquo;Well-organized travel solutions, excellent support team. Highly recommended.&rdquo;</p>
          </div>
        </div>
      </section>

      {/* Ready to Travel CTA Section */}
      <section className="w-full max-w-screen-xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-gradient-to-r from-orange-500 to-blue-500 rounded-xl my-12 sm:my-16 md:my-20" style={{ background: 'linear-gradient(135deg, #e67817 0%, #007dc0 100%)' }}>
