      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="mb-4 text-lg">Phone: <Link href="tel:+912041230000" className="text-primary hover:underline">+91-20-41230000</Link>, <Link href="tel:+919763704501" className="text-primary hover:underline">09763704501</Link></p>
            <p className="mb-4 text-lg">Email: <Link href="mailto:raj.kolpe@comfort-toursindia.com" className="text-primary hover:underline">raj.kolpe@comfort-toursindia.com</Link><br /><Link href="mailto:bookings@comfort-toursindia.com" className="text-primary hover:underline">bookings@comfort-toursindia.com</Link></p>
          </div>
          {/* Contact Form */}
